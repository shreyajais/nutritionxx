...
public class StoryActivity extends AppCompatActivity implements StoriesProgressView.StoriesListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r_seen.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( com.codewithshreya.nutritionxx.StoryActivity.this, FollowersActivity.class );
                ...
                reference.removeValue().addOnCompleteListener( new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            Toast.makeText( com.codewithshreya.nutritionxx.StoryActivity.this,"Deleted!",Toast.LENGTH_SHORT ).show();
                            finish();
                        }
                    }
                } );
    ...
    private void getStories(String userid){
        ...
        reference.addListenerForSingleValueEvent( new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                storiesProgressView.setStoriesListener( com.codewithshreya.nutritionxx.StoryActivity.this );
