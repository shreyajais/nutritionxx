...
import com.codewithshreya.nutritionxx.AddStoryActivity;
...
import com.codewithshreya.nutritionxx.StoryActivity;
...
public class StoryAdapter extends RecyclerView.Adapter<com.codewithshreya.nutritionxx.Adapter.StoryAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if( viewType == 0){
            ...
            return new com.codewithshreya.nutritionxx.Adapter.StoryAdapter.ViewHolder( view );
        }else {
